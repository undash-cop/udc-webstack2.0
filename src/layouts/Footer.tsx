...
const Footer = () => {
  ...
  const socialLinks = [
    { name: 'Facebook', href: companyData.address.facebook, icon: '📘' },
    { name: 'Twitter', href: companyData.address.twitter, icon: '🐦' },
    { name: 'LinkedIn', href: companyData.address.linkedin, icon: '💼' },
    { name: 'Instagram', href: companyData.address.instagram, icon: '📷' },
  ];
