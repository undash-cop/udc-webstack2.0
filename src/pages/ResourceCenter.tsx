  ...
  return (
    <div>
      <SEOHead
        ...
        description="Whitepapers, guides, templates, and tools for startups and growing businesses."
        keywords="resources, guides, templates, whitepapers, tools, software, automation"
      />
      ...
      <section className="section-padding bg-neutral-50">
        <div className="container-custom text-center">
          ...
          <p className="text-body-lg text-neutral-600 max-w-3xl mx-auto mb-8">
            Whitepapers, guides, templates, and tools for startups and growing businesses.
          </p>
            ...
            {filteredResources.map((resource: Resource) => (
              <div key={resource.id} className="card overflow-hidden">
                <div className="relative">
                  ...
                  />
                  <div className="absolute top-4 left-4 bg-white bg-opacity-90 px-3 py-1 rounded-full text-sm font-medium text-neutral-700">
                    {resource.type}
                  </div>
                  {resource.featured && (
