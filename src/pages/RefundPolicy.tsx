            ...
            <div className="grid gap-8">
              ...
              <section>
                ...
                <div className="space-y-6">
                  <div className="bg-blue-50 rounded-lg p-6">
                    <h3 className="text-lg font-medium text-gray-900 mb-3">Software Development Services</h3>
                    <div className="space-y-3">
                      <div>
                        <h4 className="font-medium text-gray-900">Cancellation Before Development Starts</h4>
                        <p className="text-gray-700 text-sm">Full refund minus 10% administrative fee</p>
                      </div>
                      <div>
                        <h4 className="font-medium text-gray-900">Cancellation During Development (0-25% complete)</h4>
                        <p className="text-gray-700 text-sm">75% refund of remaining work</p>
                      </div>
                      <div>
                        <h4 className="font-medium text-gray-900">Cancellation During Development (25-50% complete)</h4>
                        <p className="text-gray-700 text-sm">50% refund of remaining work</p>
                      </div>
                      <div>
                        <h4 className="font-medium text-gray-900">Cancellation After 50% Complete</h4>
                        <p className="text-gray-700 text-sm">No refund - work delivered as per milestone</p>
                      </div>
                    </div>
                  </div>

                  <div className="bg-purple-50 rounded-lg p-6">
                    <h3 className="text-lg font-medium text-gray-900 mb-3">Consulting Services</h3>
                    <div className="space-y-3">
                      <div>
                        <h4 className="font-medium text-gray-900">Hourly Consulting</h4>
                        <p className="text-gray-700 text-sm">Refund for unused hours within 30 days of purchase</p>
                      </div>
                      <div>
                        <h4 className="font-medium text-gray-900">Project-Based Consulting</h4>
                        <p className="text-gray-700 text-sm">Proportional refund based on work completed</p>
                      </div>
                      <div>
                        <h4 className="font-medium text-gray-900">Retainer Agreements</h4>
                        <p className="text-gray-700 text-sm">Refund for unused retainer amount with 30 days notice</p>
                      </div>
                    </div>
                  </div>

                  <div className="bg-orange-50 rounded-lg p-6">
                    <h3 className="text-lg font-medium text-gray-900 mb-3">Support and Maintenance</h3>
                    <div className="space-y-3">
                      <div>
                        <h4 className="font-medium text-gray-900">Monthly Subscriptions</h4>
                        <p className="text-gray-700 text-sm">Pro-rated refund for unused portion of current month</p>
                      </div>
                      <div>
                        <h4 className="font-medium text-gray-900">Annual Subscriptions</h4>
                        <p className="text-gray-700 text-sm">Pro-rated refund for unused months with 30 days notice</p>
                      </div>
                      <div>
                        <h4 className="font-medium text-gray-900">One-time Support</h4>
                        <p className="text-gray-700 text-sm">No refund after service delivery</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h3 className="text-lg font-medium text-gray-900 mb-3">Step 1: Submit Refund Request</h3>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h3 className="text-lg font-medium text-gray-900 mb-3">Step 2: Review Process</h3>
                    <p className="text-gray-700 mb-3">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h3 className="text-lg font-medium text-gray-900 mb-3">Step 3: Refund Processing</h3>
                    <p className="text-gray-700 mb-3">
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4">
                    <h3 className="text-lg font-medium text-gray-900 mb-2">Important Deadlines</h3>
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h3 className="text-lg font-medium text-gray-900 mb-3">Credit/Debit Cards</h3>
                      <ul className="list-disc list-inside space-y-1 text-gray-700 text-sm">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h3 className="text-lg font-medium text-gray-900 mb-3">Bank Transfers</h3>
                      <ul className="list-disc list-inside space-y-1 text-gray-700 text-sm">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h3 className="text-lg font-medium text-gray-900 mb-3">PayPal</h3>
                      <ul className="list-disc list-inside space-y-1 text-gray-700 text-sm">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h3 className="text-lg font-medium text-gray-900 mb-3">Checks</h3>
                      <ul className="list-disc list-inside space-y-1 text-gray-700 text-sm">
              ...
              <section>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4">
                    <h3 className="text-lg font-medium text-gray-900 mb-2">Dispute Process</h3>
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div className="bg-red-50 rounded-lg p-4">
                    <h3 className="text-lg font-medium text-gray-900 mb-2">Force Majeure Events</h3>
                  ...
                  <div className="bg-blue-50 rounded-lg p-4">
                    <h3 className="text-lg font-medium text-gray-900 mb-2">Technical Issues</h3>
                    <p className="text-gray-700 text-sm">
                  ...
                  <div className="bg-green-50 rounded-lg p-4">
                    <h3 className="text-lg font-medium text-gray-900 mb-2">Client Satisfaction</h3>
                    <p className="text-gray-700 text-sm">
