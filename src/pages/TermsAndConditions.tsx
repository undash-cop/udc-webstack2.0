          ...
          <div className="prose prose-lg max-w-none">
            <div className="grid gap-8">
              ...
              <section>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-700 mb-3">You may use our Services only for lawful purposes and in accordance with these Terms. You agree to:</p>
                    <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 mb-3">You agree not to use our Services:</p>
                    <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
              ...
              <section>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-red-50 border-l-4 border-red-400 p-4">
                    <h3 className="text-lg font-medium text-gray-900 mb-2">Copyright Infringement</h3>
                    <p className="text-gray-700">
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-medium text-gray-900 mb-3">Payment Obligations</h3>
                    <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-gray-900 mb-3">Pricing and Changes</h3>
                    <p className="text-gray-700">
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div className="bg-red-50 border-l-4 border-red-400 p-4">
                    <h3 className="text-lg font-medium text-gray-900 mb-2">Important Legal Notice</h3>
                    <p className="text-gray-700">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-gray-900 mb-3">Warranty Disclaimers</h3>
                    <p className="text-gray-700">
