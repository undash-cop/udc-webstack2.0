      ...
      <div className="container-custom">
        ...
        <div className="card p-8 lg:p-12">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="heading-page">Cookie Policy</h1>
          ...
          <div className="prose prose-lg max-w-none">
            <div className="grid gap-8">
              ...
              <section>
                ...
                <div className="space-y-6">
                  <div className="bg-green-50 border-l-4 border-green-400 p-6">
                    <h3 className="heading-card mb-3 flex items-center">
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full bg-white border border-neutral-200 rounded-lg">
                    <thead className="bg-neutral-50">
                      <tr>
                        <th className="px-6 py-3 text-left text-xs font-medium text-neutral-500 uppercase tracking-wider">Cookie Name</th>
                    ...
                    <tbody className="divide-y divide-neutral-200">
                      <tr>
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-neutral-900">_session_id</td>
                        <td className="px-6 py-4 text-sm text-neutral-700">Maintains user session</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-700">Essential</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-700">Session</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-neutral-900">_ga</td>
                        <td className="px-6 py-4 text-sm text-neutral-700">Google Analytics - distinguishes users</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-700">Analytics</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-700">2 years</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-neutral-900">_gid</td>
                        <td className="px-6 py-4 text-sm text-neutral-700">Google Analytics - distinguishes users</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-700">Analytics</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-700">24 hours</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-neutral-900">_gat</td>
                        <td className="px-6 py-4 text-sm text-neutral-700">Google Analytics - throttles request rate</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-700">Analytics</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-700">1 minute</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-neutral-900">cookie_consent</td>
                        <td className="px-6 py-4 text-sm text-neutral-700">Remembers cookie preferences</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-700">Functional</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-700">1 year</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-neutral-900">language_pref</td>
                        <td className="px-6 py-4 text-sm text-neutral-700">Stores language preference</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-700">Functional</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-neutral-700">1 year</td>
                      </tr>
                    </tbody>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-neutral-50 rounded-lg p-4">
                      <h3 className="text-lg font-medium text-neutral-900 mb-3">Google Analytics</h3>
                    ...
                    <div className="bg-neutral-50 rounded-lg p-4">
                      <h3 className="text-lg font-medium text-neutral-900 mb-3">Social Media</h3>
                      <p className="text-neutral-700 text-sm mb-3">
              ...
              <section>
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="text-lg font-medium text-neutral-900 mb-3">Cookie Consent Banner</h3>
                    <p className="text-neutral-700 mb-3">
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-400 p-4">
                    <h3 className="text-lg font-medium text-neutral-900 mb-2">Browser Settings</h3>
                    <p className="text-neutral-700 mb-3">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-neutral-50 rounded-lg p-4">
                      <h3 className="text-lg font-medium text-neutral-900 mb-3">Browser-Specific Instructions</h3>
                    ...
                    <div className="bg-neutral-50 rounded-lg p-4">
                      <h3 className="text-lg font-medium text-neutral-900 mb-3">Mobile Devices</h3>
                      <div className="space-y-2 text-sm">
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4">
                    ...
                    <ul className="list-disc list-inside space-y-1 text-neutral-700 text-sm mt-2">
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-400 p-4">
                    <h3 className="text-lg font-medium text-neutral-900 mb-2">Non-Essential Cookies</h3>
                    <p className="text-neutral-700 text-sm">
              ...
              <section>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-neutral-50 rounded-lg p-4">
                    <h3 className="text-lg font-medium text-neutral-900 mb-3">Key Privacy Principles</h3>
