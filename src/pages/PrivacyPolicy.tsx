      ...
      <div className="container-custom">
        ...
        <div className="card p-8 lg:p-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="heading-page-muted mx-auto text-center">
            ...
            <div className="grid gap-8">
              ...
              <section>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-neutral-700 mb-3">We may collect the following types of personal information:</p>
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-neutral-900 mb-3">Automatically Collected Information</h3>
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div className="bg-blue-50 border-l-4 border-blue-400 p-4">
                    <h3 className="text-lg font-medium text-neutral-900 mb-2">Consent</h3>
                    <p className="text-neutral-700">When you provide explicit consent for specific processing activities, such as marketing communications.</p>
                  </div>
                  <div className="bg-green-50 border-l-4 border-green-400 p-4">
                    <h3 className="text-lg font-medium text-neutral-900 mb-2">Contract Performance</h3>
                    <p className="text-neutral-700">When processing is necessary to perform our contract with you or to take steps at your request before entering into a contract.</p>
                  </div>
                  <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4">
                    <h3 className="text-lg font-medium text-neutral-900 mb-2">Legitimate Interests</h3>
                    <p className="text-neutral-700">When we have a legitimate business interest, such as improving our services, preventing fraud, or ensuring security.</p>
                  </div>
                  <div className="bg-red-50 border-l-4 border-red-400 p-4">
                    <h3 className="text-lg font-medium text-neutral-900 mb-2">Legal Obligation</h3>
                    <p className="text-neutral-700">When we are required to process data to comply with legal obligations.</p>
                  </div>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-lg font-medium text-neutral-900 mb-3">Service Provision</h3>
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-neutral-900 mb-3">Legal & Security</h3>
                    <ul className="list-disc list-inside space-y-2 text-neutral-700">
              ...
              <section>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-neutral-50 rounded-lg p-4">
                    <h3 className="text-lg font-medium text-neutral-900 mb-2">Retention Periods</h3>
              ...
              <section>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <h3 className="text-lg font-medium text-neutral-900">GDPR Rights (EU Residents)</h3>
                    <ul className="list-disc list-inside space-y-2 text-neutral-700">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-lg font-medium text-neutral-900">CCPA Rights (California Residents)</h3>
                    <ul className="list-disc list-inside space-y-2 text-neutral-700">
              ...
              <section>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <h3 className="text-lg font-medium text-neutral-900 mb-3">Organizational Safeguards</h3>
                      <ul className="list-disc list-inside space-y-2 text-neutral-700">
              ...
              <section>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-neutral-50 rounded-lg p-4">
                    <h3 className="text-lg font-medium text-neutral-900 mb-2">Cookie Categories</h3>
                    <ul className="list-disc list-inside space-y-1 text-neutral-700">
              ...
              <section>
                <h2 className="heading-section">International Data Transfers</h2>
              ...
              {/* Children's Privacy */}
              <section>
                <h2 className="heading-section">Children's Privacy</h2>
                <p className="text-neutral-700">
              ...
              {/* Policy Updates */}
              <section>
                <h2 className="heading-section">Changes to This Policy</h2>
                <p className="text-neutral-700">
